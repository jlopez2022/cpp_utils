//Pasa de lat,lon (deg) a UTM y al reves
//VER http://www.koders.com/cpp/fid56D52408FAC344874E65BF9A1C54F3731C96A39B.aspx?s=string
//lat lon debe ir en grados decimales=grados+minutos/60
...
//=======================================================================
// Purpose:
//  This function converts the specified lat/lon coordinate (deg) to a UTM
//  coordinate.
// Parameters:
//  double a:
...
//  double& lat:
//      Upon exit, lat contains the latitude (deg).
//  double& lon:
//      Upon exit, lon contains the longitude (deg).
// Notes:
//  The code in this function is a C conversion of some of the source code
