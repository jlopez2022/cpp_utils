//Ver al final ejemplom de uso
//Ver Colorimetria_V1.cpp
#include<assert.h>
#include<math.h>
...
int cciRGBtoHSV(double r, double g, double b, double* h, double* s, double* v)
{
  double var_Min;
  double var_Max;
  double del_Max;
...
void main()
{
	...
	g=bgr_med[0][1];
	b=bgr_med[0][2];
	ccRGBtoXYZ(r/256,g/256,b/256,&x,&y,&z,D65_10);
//	ccXYZtoCIE_Lab(x,y,z,&L,&A,&B,D65_10);
	ccXYZtoHunterLab(x,y,z,&L,&A,&B);
}
